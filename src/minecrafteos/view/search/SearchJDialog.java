...
public class SearchJDialog extends javax.swing.JDialog {
    ...
    public void setItemsCraftingButton(ArrayList<ObjectM> recepieCraft, String imageCraft){
        ...
        for(ObjectM item : recepieCraft){
            if(item == null){
                pathImage = "/img/itemEmpty.png";
            } else {
                pathImage = item.getImage();
            }
    ...
    private Image getImageItemCraft01(ArrayList<String> pathsImages){
        ...
        try {
            iconButton = new ImageIcon(getClass().getResource(pathImage));
        } catch (NullPointerException ex){
            iconButton = new ImageIcon(getClass().getResource("/img/itemDefault.png"));
        }
    ...
    private Image getImageItemCraftResult(String pathImage){
        ...
        try {
            ...
            iconButton = new ImageIcon(getClass().getResource("/img/itemDefaultCraft.png"));
        }
    ...
    private Image getImageItemFurnaceResult(String pathImage){
        ...
        try {
            ...
            iconButton = new ImageIcon(getClass().getResource("/img/itemDefaultFurnace.png"));
        }
